...
(function(){
	...
	$(document).ready(function(){
		...
		$('.cate_li').mouseenter(function(){
			var html ="";
			if(this.id=="li_1"){
				html = "<div class='categoryTwo'><a target='_blank' href='http://3dly.net/haixindianshi/'>电视产品</a></div>"+
				        "<div class'categoryTwo'><a target='_blank' href='http://3dly.net/changhong/'>长虹电视产品</a></div>";
				$(".category").html(html);
			};
			if(this.id=="li_2"){
				html = "<div class='categoryTwo'><a target='_blank' href='http://3dly.net/lanyachanpin/'>蓝牙产品</a></div>";
				$(".category").html(html);
			};
			if(this.id=="li_3"){
				html = "<div class='categoryTwo'><a target='_blank' href='http://3dly.net/yinxiang/'>音响产品</a></div>";
				$(".category").html(html);
			};
			if(this.id=="li_4"){
				html = "<div class='categoryTwo'><a target='_blank' href='http://3dly.net/diannao/'>电脑产品</a></div>"+
